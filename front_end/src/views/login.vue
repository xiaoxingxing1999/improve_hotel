  ...
  <div class='login-back' :style="'background: #f0f2f5 url('+backgroundImgOnShow+') no-repeat ;'">
    ...
    <div class="top">
      <div class="header">
        ...
        <div>  
          <span class="title">酒店预订管理系统</span><br/><span class="title" style="font-size:35px">HRMS</span>
        </div>
      </div>
      <div class="desc"></div>
    </div>
    <a-form id="formLogin" class="user-layout-login" ref="formLogin" :form="form">
      <a-tabs
        ...
        :tabBarStyle="{ textAlign: 'center', font:' bold 16px ' ,borderBottom: 'unset' ,color:'white'}"
