        ...
        <tbody>
          <tr class="ant-descriptions-row">
            <td colspan="2" rowspan="2" class="ant-descriptions-item-content imgContainer">
              <img v-if="hotelEdit.picture" :src="hotelEdit.picture" />
              <img v-else src="@/assets/cover.jpeg" alt="暂无" />
            </td>
            <th class="ant-descriptions-item-label ant-descriptions-item-colon">酒店ID</th>
            <td colspan="1" class="ant-descriptions-item-content">{{hotelEdit.hotelId}}</td>
            <th class="ant-descriptions-item-label ant-descriptions-item-colon">酒店名称</th>
            <td colspan="1" class="ant-descriptions-item-content">{{hotelEdit.hotelName}}</td>
          </tr>
          <tr class="ant-descriptions-row">
            <th class="ant-descriptions-item-label ant-descriptions-item-colon">电话号码</th>
            <td colspan="3" class="ant-descriptions-item-content">{{hotelEdit.phoneNum}}</td>
          </tr>
          ...
          <tr class="ant-descriptions-row">
            ...
            >{{hotelEdit.hotelServe?hotelEdit.hotelServe.split('|').join(', '):'暂无'}}</td>
          </tr>
          <tr class="ant-descriptions-row">
            <th class="ant-descriptions-item-label ant-descriptions-item-colon">酒店描述</th>
            <td colspan="5" class="ant-descriptions-item-content">{{hotelEdit.hotelDescription}}</td>
          </tr>
          <!-- <th class="ant-descriptions-item-label ant-descriptions-item-colon">修改申请状态</th>
            <td colspan="1" class="ant-descriptions-item-content">
              <a-badge
                :status="editStateColor(hotelEdit.status)"
                :text="editStateText(hotelEdit.status)"
              />
          </td>-->
        </tbody>
      </table>
...
export default {
  ...
  methods: {
    toHotel() {
      this.$router.push({
        name: "hotelDetail",
        params: { hotelId: this.hotelEdit.hotelId }
      });
    },
    transDateFrom(date) {
